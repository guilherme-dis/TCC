...
def printMatrixGraficoDeLinha(lattices):
    ...
    plt.plot(recuperados, label='Recuperados', color='green')
...
def printMatrixGraficoDeLinha2(lattices):
    plt.clf()  
    
    # Isso é um gráfio de linha, das execuções médias, juntando 30 execuções.
